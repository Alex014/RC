<?php
//01.01.2001
$lv['date_format_regex'] = "([\d]{2})\.([\d]{2})\.([\d]{4})";
//23:23
$lv['time_format_regex'] = "([\d]{2}):([\d]{2}):{0,1}([\d]{0,2})";
//01.01.2001 23:23
$lv['date_time_format_regex'] = "$lv[date_format_regex][\s]+$lv[time_format_regex]";


/**
 * Day - ORDER in "DATE_FORMAT_REGEX" regular expression
 */
$lv['date_format_day_order'] = 1;
/**
 * Month - ORDER in "DATE_FORMAT_REGEX" regular expression
 */
$lv['date_format_month_order'] = 2;
/**
 * Year - ORDER in "DATE_FORMAT_REGEX" regular expression
 */
$lv['date_format_year_order'] = 3;
/**
 * Hour - ORDER in "TIME_FORMAT_REGEX" regular expression
 */
$lv['time_format_hour_order'] = 1;
/**
 * Minute - ORDER in "TIME_FORMAT_REGEX" regular expression
 */
$lv['time_format_minute_order'] = 2;
/**
 * Second - ORDER in "TIME_FORMAT_REGEX" regular expression
 */
$lv['time_format_second_order'] = 3;


$lv['date_format'] = "<:day>.<:month>.<:year>";
$lv['time_format'] = "<:hour>:<:minute>";
$lv['time_format_full'] = "<:hour>:<:minute>:<:second>";
$lv['date_time_format'] = "$lv[date_format] $lv[time_format]";
$lv['date_time_format_full'] = "$lv[date_format] $lv[time_format_full]";
